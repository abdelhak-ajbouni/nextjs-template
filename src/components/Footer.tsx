...
export default function Footer({ }: Props) {
  ...
  return (
    <footer className="bg-secondary border border-t-gray-300 p-4 sm:p-6">
      <Container className=''>
        ...
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0 w-1/3">
            <Link href="/" className="flex items-center">
              <Image
                className="mr-3 h-8 cursor-pointer"
            ...
            <p className='text-secondary'>
              ...
              Culpa ipsa aperiam vitae facere dolore quam temporibus explicabo quia? Libero repellendus,
              provident quibusdam culpa eos delectus rem sit eveniet! Quae, perferendis!
            </p>
          </div>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-secondary sm:text-center">© {date.getFullYear()} <span>Website Name</span>. All Rights Reserved.
          </span>
